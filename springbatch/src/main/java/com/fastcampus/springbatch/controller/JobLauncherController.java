...
public class JobLauncherController {
    ...
    public ResponseEntity<String> runHelloJob() {
        try {
            JobParameters jobParameters = new JobParametersBuilder(jobExplorer) // helloJob에서 받을 파라미터를 설정해주는 부분
    ...
    public ResponseEntity<String> runCustomerFileJob() {
        try {
            ...
            JobExecution jobExecution =
                    jobLauncher.run(customerFileJob, jobParameters);    // CustomerFile을 Job Launcher로 실행
